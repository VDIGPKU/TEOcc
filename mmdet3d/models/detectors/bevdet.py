...
from mmdet3d.models.backbones import  SwinTransformer
    ...
    def simple_test(self,
        ...
        if self.pts_bbox_head:
            ...
            if False:
                ...
                plt.savefig("/home/wangxinhao/vis/" + datetime.now().strftime('%H:%M:%S') + '--scene=' + img_metas[0][
                    'scene_token'] + '--idx=' + img_metas[0]['sample_idx'] + ".png")
                print('\n******** END PRINT GT**********\n')
        if self.pts_seg_head:
